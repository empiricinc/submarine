...
//print_r($posts);
      ...
      $AllCities = $this->provinceCity->Alldistricts();
...
<ul class="nav nav-tabs">
 ...
 <?php if($viewTab=='getReservedRecords' || $viewTab=='reserveselectedrecord'){ ?>
      ...
      <li <?php echo (($viewTab=='reserveselectedrecord') ? 'class="active"' : ''); ?>>
        <?php echo '<a href="'.base_url().'job_longlisted/closethisjob/'. $theJobId . '"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Close This Job </button></a>';  ?>
      </li>
...
<?php if ($allCandidates){ // All Auto Long Listing ?>
        ...
        <tbody>
           ...
           <?php 
            ...
            <tr>
                ...
                <td><?php if($getage){ foreach($getage as $ag){ echo $theag = $ag->name; } }else{ echo $theag = '--'; }  ?></td>
                <td><?php if($getEducation){ foreach($getEducation as $ed){ echo  $edname = $ed->name; } }else{ echo $edname = '--'; }   ?></td>
                <td><?php if($getProvince){ foreach($getProvince as $domic){ echo  $domicname = $domic->name; } }else{ echo $domicname = '--'; }   ?></td>
                <td><?php if($getProvince){ foreach($getProvince as $prov){ $provience_id = $prov->id; echo  $provname = $prov->name; } }else{ echo $provname = '--'; }   ?></td>
                <td><?php if($getcityName){ foreach($getcityName as $citi){ $city_id = $citi->id; echo $citiName =  $citi->name; } }else{ echo $citiName = '--'; }   ?></td>
                <td>
...
$Checkofferletter='';
$OfferLetter=''; 
$Checkofferletter = $this->db->select('user_id,status')->from('employee_offer_letter')->where(array('user_id'=>$candidate->application_id))->get();
$OfferLetter = $Checkofferletter->result();

if(!empty($OfferLetter)){

 //echo $this->db->last_query(); 
$CheckOfferLetterStatus='';
$OfferLRow='';
foreach ($OfferLetter as $OfferLRow)
{
        //$CheckContractRow = $OfferLRow->user_id;
        $CheckOfferLetterStatus = $OfferLRow->status;
        if ($CheckOfferLetterStatus==0) {
        echo '<button type="button" class="btn btn-warning">Offer letter Waiting for Approval</button> '; 
           
        } elseif ($CheckOfferLetterStatus==1) {
        echo '<button type="button" class="btn btn-success"><span class="glyphicon glyphicon-ok"></span> Offer letter Approved</button> ';
           
        }       
}

}else{ echo '<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#sendofferletter'.$i.'">Send Offer letter</button> ';  }
...
<div class="modal fade" id="sendofferletter<?php echo $i; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
             <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Ok Send Offer Letter </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">×</span>
                </button>
              </div>
              <div class="container">
          <form action="<?php echo site_url("job_post/send_offer_letter") ?>" method="post" name="add_job" id="xin-form">
                    ...
                    <div class="row text-center">
                        <div class="col-lg-10">
                             <button type="submit" class="btn btn-primary save">Send Offer Letter</button>
                        </div>
                    </div>
                    <br>
 ...
 <div class="modal fade" id="contractform<?php echo $i; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <form action="<?php echo site_url("job_post/assign_employee_contract") ?>" method="post" name="add_job" id="xin-form">
                        ...
                        <div class="col-lg-10">
                            <div class="form-group">
                                <label class="control-label lablewidth">Contract Type: </label>
                                  <select class="form-control ddfield" name="contract_type" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_job_type');?>">
                                  <option value="">Job Types</option>
                                  <?php foreach($all_job_types as $job_type) {?>
                                  <option value="<?php echo $job_type->job_type_id?>" <?php echo ($job_type->job_type_id==5)? 'selected="selected"': ''; ?> ><?php echo $job_type->type?></option>
                                  <?php } ?>
                                </select>
                            </div>
                    </div>
                    ...
                    <div class="row text-center">
                        <div class="col-lg-10">
                             <button type="submit" class="btn btn-primary save">Send Contract</button>
                        </div>
                    </div>
                    <br>
                        ...
                        <div class="portlet-body form">
                          <form action="<?php echo site_url("job_post/add_application_form") ?>" class="form-horizontal" id="Form_Employee_Edit" method="post" accept-charset="utf-8">
                            <div class="form-body">
                                ...
                                <input type="hidden" name="provience_id" value="<?php  echo $provience_id; ?>">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="job_title" class="form-control fcn" value="<?php echo $jobTitle; ?>" placeholder="" readonly="readonly">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="department_name" class="form-control fcn" value="<?php echo $department_name; ?>" placeholder="" readonly="readonly" >
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="father_name" class="form-control fcn" value="" placeholder="Father Name">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <select name="relation_id" id="relation_id" class="form-control fcn select input-large">
                            ...
                            <option value="5">Info Not Available</option>
                        </select>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="date_of_joining" id="date_of_joining" class="form-control fcn date-picker" placeholder="Date of birth" format="dd-MM-yyyy" value="" required="required">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="cnic" class="form-control fcn mask_number13" placeholder="Employee's CNIC" value="" required="required">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="cnic_expiry_date" name="cnic_expiry_date" class="form-control fcn date-picker" placeholder="CNIC Expiry Date" format="dd-MM-yyyy" value="" required="required">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="other_passport_id" name="other_passport_id" class="form-control fcn" placeholder="Applicant's other id no" value="" required="required">
                        <div class="help-block">
                            e.g Passport Number
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">                                                
                        <select name="language" id="language" class="form-control fcn select2me input-large select2-offscreen" tabindex="-1">
                            ...
                            <option value="6" selected="selected">Urdu</option>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="contact_number" name="contact_number" class="form-control fcn mask_number13" placeholder="Mobile Number" value="" required="required">
                        <div class="help-block">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="personal_contact" name="personal_contact" class="form-control fcn" placeholder="Phone Number" value="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" id="contract_expiry_date" name="contract_expiry_date" class="form-control fcn date-picker" placeholder="CNIC Expiry Date" format="dd-MM-yyyy" disabled="" value="" required="required">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="username" class="form-control fcn" value="<?php echo $candidate->fullname; ?>">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="text" name="password" class="form-control fcn" value="123456">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group" id="province_section">
                    ...
                    <div class="col-md-6">
                        <select name="resident_province" id="resident_province" class="form-control fcn" required="required">
            ...
            <div class="col-md-6">
                <div class="form-group" id="district_section">
                    ...
                    <div class="col-md-6">
                      <select name="resident_district" id="resident_district" class="form-control fcn select2me input-large select2-offscreen" required="required">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group" id="resident_tehsil_section">
                    ...
                    <div class="col-md-6">
                        <select name="resident_tehsil" id="resident_tehsil" class="form-control fcn select2me select2-offscreen" required="required">
            ...
            <div class="col-md-6">
                <div class="form-group" id="resident_uc_section">
                    ...
                    <div class="col-md-6">
                        <select name="resident_uc" id="resident_uc" class="form-control fcn select2me select2-offscreen" required="required">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group" id="permanent_province_section">
                    ...
                    <div class="col-md-6">
                        <select name="permanent_province" id="permanent_province" class="form-control fcn select2me input-medium select2-offscreen" required="required">
            ...
            <div class="col-md-6">
                <div class="form-group" id="permanent_district_section">
                    ...
                    <div class="col-md-6">
                        <select name="permanent_district" id="permanent_district" class="form-control fcn select2me input-medium select2-offscreen" required="required">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group" id="permanent_tehsil_section">
                    ...
                    <div class="col-md-6">
                      <select name="permanent_tehsil" id="permanent_tehsil" class="form-control fcn select2me input-medium select2-offscreen" required="required">
            ...
            <div class="col-md-6">
                <div class="form-group" id="permanent_uc_section">
                    ...
                    <div class="col-md-6">
                      <select name="permanent_uc" id="permanent_uc" class="form-control fcn select2me input-medium select2-offscreen" required="required">
            ...
            <div class="row" hidden="">
                <div class="col-md-6">
                    <div class="form-group" id="province_section">
                        ...
                        <div class="col-md-6">
                            <input type="text" value="<?php echo  $provname; ?>" class="form-control fcn" readonly="">
                        </div>
            ...
            <div class="row" hidden="">
                <div class="col-md-6">
                    <div class="form-group" id="province_section">
                        ...
                        <div class="col-md-6">
                            <input type="text" value="<?php echo  $citiName; ?>" class="form-control fcn" readonly="">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label col-md-6 lcn">
                            ...
                            <?php 
                                $jobcod = $jobTitle; $jobcod = strstr($jobcod, "("); $jobcod = strstr($jobcod, ")", true); 

                             ?>
                        </label>
                        <div class="col-md-6">
                            <input type="text" id="job_area_identification_code" class="form-control fcn" placeholder="Area Code" value="<?php echo $jobcod; ?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" id="jpic" class="form-control fcn" placeholder="New Area Code" value="<?php echo $jobcod; ?>">
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="last_qualification_name" name="last_qualification_name" class="form-control fcn" placeholder="Last Qualification Name" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" id="province_section">
                                            ...
                                            <div class="col-md-8">
                                                <select name="tax_deduction" class="form-control select2me input-large select2-offscreen" required="required">
                                                    <option value="0">Select Brackets</option>
                                                    <option value="0">Rs.0 to Rs.60,000 (0%)</option>
                                                    <option value="5">Rs.60,000 to Rs.100,000 (5%)</option>
                                                    <option value="10">Rs.150,000 to Rs.200,000 (10%)</option>
                                                    <option value="15">Rs.200,000 to Rs.300,000 (15%)</option>
                                                    <option value="20">Rs.300,000 to Rs.400,000 (20%)</option>
                                                </select>
                                            </div>
...
<?php }else{ echo '<div class="alert alert-warning text-center" role="alert"> No Auto Long Listing Found... </div>';} ?>
