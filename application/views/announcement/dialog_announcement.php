  ...
  <div class="modal-body">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="display: table-cell;"><?php foreach($all_office_locations as $location) {?><?php if($location->location_id==$location_id):?> <?php echo $location->location_name?> <?php endif;?><?php } ?></td>
      </tr>
      <tr>
