                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a target="_blank" href="<?php if($scheduled->designation_id == 12 OR $scheduled->designation_id == 13){ echo base_url("interview/form_sm/{$scheduled->rollnumber}"); }elseif($scheduled->designation_id == 5){ echo base_url("interview/form_dhcso/{$scheduled->rollnumber}"); }elseif($scheduled->designation_id == 8 OR $scheduled->designation_id == 14){ echo base_url("interview/form_fcm/{$scheduled->rollnumber}"); }else{ echo base_url("interview/form_dhcso/{$scheduled->rollnumber}"); } ?>" class="btn btn-primary btn-xs">Int 1</a>
                        <a target="_blank" href="<?php if($scheduled->designation_id == 12 OR $scheduled->designation_id == 13){ echo base_url("interview/form_sm/{$scheduled->rollnumber}"); }elseif($scheduled->designation_id == 5){ echo base_url("interview/form_dhcso/{$scheduled->rollnumber}"); }elseif($scheduled->designation_id == 8 OR $scheduled->designation_id == 14){ echo base_url("interview/form_fcm/{$scheduled->rollnumber}"); }else{ echo base_url("interview/form_dhcso/{$scheduled->rollnumber}"); } ?>" class="btn btn-primary btn-xs">Int 2</a>
                        <a target="_blank" href="<?php if($scheduled->designation_id == 12 OR $scheduled->designation_id == 13){ echo base_url("interview/form_sm/{$scheduled->rollnumber}"); }elseif($scheduled->designation_id == 5){ echo base_url("interview/form_dhcso/{$scheduled->rollnumber}"); }elseif($scheduled->designation_id == 8 OR $scheduled->designation_id == 14){ echo base_url("interview/form_fcm/{$scheduled->rollnumber}"); }else{ echo base_url("interview/form_dhcso/{$scheduled->rollnumber}"); } ?>" class="btn btn-primary btn-xs">Int 3</a>
                    </td>
                    </tr>
                  <?php endforeach; ?>
                  </tbody>
