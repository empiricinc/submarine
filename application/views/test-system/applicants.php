...
*  Author: Saddam
*  File location: views / test-system / applicants.php
*/
?>
					...
					<div class="col-md-8">
						<div class="tabelHeading">
							...
							<h3>
									all applicants 
									<span>
										(list of the applicants applied for jobs) 
									</span> | 
								<small>
									<a href="<?php echo base_url('tests/total_appeared'); ?>">See Applicants appeared in Exam</a>
								</small>
							</h3>
							<?php else: ?> 
								<h3>applicant detail <span>(see applicant's detail)</span></h3>
							<?php endif; ?>
						</div>
					</div>
					<div class="col-md-4">
								...
								<table class="table">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="<?php echo base_url(); ?>tests/detail_job/<?php echo $applicant->job_id; ?>"><?= substr($applicant->job_title, 0, 24).' ...'; ?></a>
											</td>
											<td>
					...
					<div class="col-md-8">
						<div class="tabelHeading">
							<h3>you've searched for:  
								<span>
									<?php echo $_GET['search_applicant']; ?>
								</span>
							</h3>
						</div>
					</div>
