...
<div class="row m-b-1">
  <div class="col-md-12">
    <div class="box box-block bg-white col-md-12">
      <div class="row">
        <div class="col-md-12">
          <h2><strong><?php echo $this->lang->line('xin_acc_account_statement');?></strong></h2>
          <div class="row">
            <div class="col-md-12">
            <form class="add form-hrm report-params" method="post" name="report_account_statement" id="hrm-form" action="report_statement_list">
