...
<form class="m-b-1" action="<?php echo site_url("accounting/bankcash_update").'/'.$bankcash_id; ?>" method="post" name="bankcash_update" id="bankcash_update">
  <input type="hidden" name="_method" value="EDIT">
  <input type="hidden" name="_token" value="<?php echo $bankcash_id;?>">
  <input type="hidden" name="ext_name" value="<?php echo $account_name;?>">
				...
				success: function (JSON) {
					if (JSON.error != '') {
						...
						var xin_table = $('#xin_table').dataTable({
							"bDestroy": true,
							"ajax": {
								url : "<?php echo site_url("accounting/bank_cash_list") ?>",
								type : 'GET'
							},
...
<form class="m-b-1" action="<?php echo site_url("accounting/deposit_update").'/'.$deposit_id; ?>" method="post" name="deposit_update" id="deposit_update">
  <input type="hidden" name="_method" value="EDIT">
  <input type="hidden" name="_token" value="<?php echo $deposit_id;?>">
  <div class="modal-body">
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
			...
			success: function(JSON)
			{
				if (JSON.error != '') {
					...
					var xin_table = $('#xin_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("accounting/deposit_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<form class="m-b-1" action="<?php echo site_url("accounting/expense_update").'/'.$expense_id; ?>" method="post" name="expense_update" id="expense_update">
  <input type="hidden" name="_method" value="EDIT">
			...
			success: function(JSON)
			{
				if (JSON.error != '') {
					...
					var xin_table = $('#xin_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("accounting/expense_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<form class="m-b-1" action="<?php echo site_url("accounting/transfer_update").'/'.$transfer_id; ?>" method="post" name="transfer_update" id="transfer_update">
  <input type="hidden" name="_method" value="EDIT">
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table = $('#xin_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("accounting/transfer_list") ?>",
							type : 'GET'
						},
						"fnDrawCallback": function(settings){
						$('[data-toggle="tooltip"]').tooltip();          
...
<form class="m-b-1" action="<?php echo site_url("accounting/update_payer").'/'.$payer_id; ?>" method="post" name="update_payer" id="update_payer">
  <input type="hidden" name="_method" value="EDIT">
  <input type="hidden" name="_token" value="<?php echo $payer_id;?>">
  <input type="hidden" name="ext_name" value="<?php echo $payer_name;?>">
  <div class="modal-body">
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
				...
				success: function (JSON) {
					if (JSON.error != '') {
						...
						var xin_table = $('#xin_table').dataTable({
							"bDestroy": true,
							"ajax": {
								url : "<?php echo site_url("accounting/payers_list") ?>",
								type : 'GET'
							},
							"fnDrawCallback": function(settings){
							$('[data-toggle="tooltip"]').tooltip();          
...
<form class="m-b-1" action="<?php echo site_url("accounting/update_payee").'/'.$payee_id; ?>" method="post" name="update_payee" id="update_payee">
  <input type="hidden" name="_method" value="EDIT">
  <input type="hidden" name="_token" value="<?php echo $payee_id;?>">
  <input type="hidden" name="ext_name" value="<?php echo $payee_name;?>">
  <div class="modal-body">
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
				...
				success: function (JSON) {
					if (JSON.error != '') {
						...
						var xin_table = $('#xin_table').dataTable({
							"bDestroy": true,
							"ajax": {
								url : "<?php echo site_url("accounting/payees_list") ?>",
								type : 'GET'
							},
							"fnDrawCallback": function(settings){
							$('[data-toggle="tooltip"]').tooltip();          
