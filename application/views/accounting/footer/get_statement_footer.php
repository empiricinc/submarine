...
<tr>
  <th colspan="3">&nbsp;</th>
  <th>xin_acc_credit: <?php echo $this->Xin_model->currency_sign($transaction_credit);?></th>
  <th>xin_acc_debit: <?php echo $this->Xin_model->currency_sign($transaction_debit);?></th>
  <th>xin_acc_balance: <?php echo $this->Xin_model->currency_sign($balance2);?></th>
</tr>