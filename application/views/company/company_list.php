              ...
              <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <select class="form-control" name="company_type" data-plugin="xin_select" data-placeholder="Project Type">
                ...
                <div class="col-md-6">
                   <div class="form-group">
                    ...
                    <textarea class="form-control textarea" placeholder="<?php echo $this->lang->line('xin_long_description');?>" name="project_description" cols="30" rows="15" id="project_description"></textarea>
                  </div>
                </div>  
...
<div class="row">
                    ...
                    <label for="company_name">Location</label>

                    <select class="form-control" name="company" data-plugin="select_hrm" data-placeholder="location">
                    ...
                    <label for="company_name">Cities</label>

                    <select class="form-control" name="Provinces" data-plugin="select_hrm" data-placeholder="Cities">
                      ...
                      <option value="2"> Mardan</option>
                      <option value="3"> Swat</option>
                      <option value="4"> Banu</option>
                      <option value="5"> Sawabi</option>
...
<div class="box box-block bg-white">
  ...
  <h2><strong><?php echo $this->lang->line('xin_list_all');?></strong> Projects <?php //echo $this->lang->line('xin_companies');?>
