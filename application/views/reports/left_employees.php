<section class="secMainWidthFilter hide-from-print">
	<div class="row marg">
		...
		<div class="tabelHeading">
			<h3>Search Criteria <a href="javascript:void(0);" class="fa fa-refresh clear-form"></a></h3>
		</div>
		<form action="<?= base_url(); ?>Reports/employees" method="post" id="employee-search-form">
