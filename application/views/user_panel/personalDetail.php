<section class="secMainWidthFilter">
        ...
        <div class="tabelHeading">
          ...
          <div class="employee-info-nav">
            <ul class="nav nav-4 nav-tabs-link-cl">
              <li class="nav-item nav-item-link active-link" id="user_details_1"> 
                      <a class="nav-link nav-tabs-link" href="#user_basic_info" data-profile="1" data-profile-block="user_basic_info" data-toggle="tab" aria-expanded="true"> 
                              <i class="fa fa-user"></i> 
                              <?php echo $this->lang->line('xin_e_details_basic');?> 
                      </a> 
              </li>
              <li class="nav-item nav-item-link" id="user_details_2"> <a class="nav-link nav-tabs-link" href="#profile-picture" data-profile="2" data-profile-block="profile_picture" data-toggle="tab" aria-expanded="true"> <i class="fa fa-camera"></i> <?php echo $this->lang->line('xin_e_details_profile_picture');?> </a> 
              </li>

              <li class="nav-item nav-item-link" id="user_details_15"> <a class="nav-link nav-tabs-link" href="#immigration" data-profile="15" data-profile-block="immigration" data-toggle="tab" aria-expanded="true"> <i class="fa fa-plane"></i> <?php echo $this->lang->line('xin_employee_immigration');?> </a> </li>

              <li class="nav-item nav-item-link" id="user_details_3"> <a class="nav-link nav-tabs-link" href="#contact" data-profile="3" data-profile-block="contact" data-toggle="tab" aria-expanded="true"> <i class="fa fa-phone"></i> <?php echo $this->lang->line('xin_employee_emergency_contacts');?> </a> </li>
      ...
      <section class="secFormLayout">
        <div class="mainInputBg">
          <div class="row">
            <div class="col-lg-12">
              <div class="tabelHeading">
                <h3 id="detail-box-title">Employee Detail</h3>
              </div>
            </div>
          </div>
  ...
  <div class="current-tab animated fadeInRight" id="user_basic_info"  aria-expanded="false">
    ...
    <form id="basic_info" action="<?php echo site_url("employees/basic_info") ?>" name="basic_info" method="post">
      ...
      <div class="box box-block bg-white">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_employee_first_name');?>" name="first_name" type="text" value="<?php echo $first_name;?>" readonly>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_employee_last_name');?>" name="last_name" type="text" value="<?php echo $last_name;?>" readonly>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('dashboard_employee_id');?>" name="employee_id" type="text" value="<?php echo $employee_id;?>" readonly>
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('dashboard_username');?>" name="username" type="text" value="<?php echo $username;?>" readonly>
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('dashboard_email');?>" name="email" type="text" value="<?php echo $email;?>">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <select class="form-control new-style" name="department_id" id="aj_department" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_employee_department');?>" disabled>
          ...
          <div class="col-md-4">
            ...
            <div class="form-group" id="designation_ajax">
              ...
              <select class="form-control new-style" name="designation_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_designation');?>" disabled>
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <select class="form-control new-style" name="role" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_employee_role');?>" disabled>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style date" placeholder="<?php echo $this->lang->line('xin_employee_dob');?>" name="date_of_birth" type="text" value="<?php echo $date_of_birth;?>" disabled>
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style date" placeholder="<?php echo $this->lang->line('xin_employee_doj');?>" name="date_of_joining" type="text" value="<?php echo $date_of_joining;?>" disabled>
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style date" placeholder="<?php echo $this->lang->line('xin_employee_dol');?>" name="date_of_leaving" type="text" value="<?php echo $date_of_leaving;?>" disabled>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <select class="form-control new-style" name="gender" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_employee_gender');?>" disabled>
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <select class="form-control new-style" name="marital_status" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_employee_mstatus');?>">
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_contact_number');?>" name="contact_no" type="text" value="<?php echo $contact_no;?>">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <select class="form-control new-style" name="company_id" id="aj_company" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('left_company');?>" disabled>
            ...
            <div class="form-group">
              ...
              <select class="form-control new-style" name="status" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('dashboard_xin_status');?>" disabled>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_employee_address');?>" name="address" cols="30" rows="3" id="address"><?php echo $address;?></textarea>
        ...
        <button type="submit" class="btn btnSubmit newBtnStyle save"><?php echo $this->lang->line('xin_save');?></button>
  ...
  <div class="current-tab animated fadeInRight" id="profile_picture" style="display:none;">
      ...
      <div class="box box-block bg-white">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class='form-group'> <span class="btn btnSubmit newBtnStyle btn-file"> <?php echo $this->lang->line('xin_browse');?>
  ...
  <div class="current-tab animated fadeInRight" id="immigration" style="display:none;">
    ...
    <div class="box box-block bg-white">
      ...
      <form id="immigration_info" action="<?php echo site_url("employees/immigration_info") ?>" enctype="multipart/form-data" name="immigration_info" method="post">
        ...
        <h2><strong><?php //echo $this->lang->line('xin_add_new');?></strong> <?php //echo $this->lang->line('xin_employee_immigration');?></h2>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <select name="document_type_id" id="document_type_id" class="form-control new-style" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_e_details_choose_dtype');?>">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_employee_document_number');?>" name="document_number" type="text">
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style date" placeholder="Issue Date" name="issue_date" type="text">
          ...
          <div class="col-md-2">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style date" placeholder="<?php echo $this->lang->line('xin_e_details_doe');?>" name="expiry_date" type="text">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <span class="btn btnSubmit newBtnStyle btn-file"> <?php echo $this->lang->line('xin_browse');?>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style date" placeholder="<?php echo $this->lang->line('xin_eligible_review_date');?>" name="eligible_review_date" type="text">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <select class="form-control new-style" name="country" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_country');?>">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <div class="">
                ...
                <button type="submit" class="btn btnSubmit newBtnStyle save"><?php echo $this->lang->line('xin_save');?> <i class="icon-circle-right2 position-right"></i> <i class="icon-spinner3 spinner position-left"></i></button>
    ...
    <div class="box box-block bg-white">
      ...
      <h2><strong><?php //echo $this->lang->line('xin_assigned_immigration');?></strong> <?php //echo $this->lang->line('xin_records');?></h2>
  ...
  <div class="current-tab animated fadeInRight" id="social_networking" style="display:none;">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_fb_profile');?>" name="facebook_link" type="text" value="<?php echo $facebook_link;?>">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_twit_profile');?>" name="twitter_link" type="text" value="<?php echo $twitter_link;?>">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_blogr_profile');?>" name="blogger_link" type="text" value="<?php echo $blogger_link;?>">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_linkd_profile');?>" name="linkdedin_link" type="text" value="<?php echo $linkdedin_link;?>">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_gplus_profile');?>" name="google_plus_link" type="text" value="<?php echo $google_plus_link;?>">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_insta_profile');?>" name="instagram_link" type="text" value="<?php echo $instagram_link;?>">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_pintrst_profile');?>" name="pinterest_link" type="text" value="<?php echo $pinterest_link;?>">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_utube_profile');?>" name="youtube_link" type="text" value="<?php echo $youtube_link;?>">
  ...
  <div class="current-tab animated fadeInRight" id="contact" style="display:none;">
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            ...
            <div class="form-group">
              ...
              <select class="form-control new-style" name="relation" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_one');?>">
          ...
          <div class="col-md-7">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_work');?>" name="work_email" type="text">
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_personal');?>" name="personal_email" type="text">
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_name');?>" name="contact_name" type="text">
          ...
          <div class="col-md-7">
            ...
            <div class="form-group" id="designation_ajax">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_address_1');?>" name="address_1" type="text">
        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-xs-8">
                  ...
                  <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_work');?>" name="work_phone" type="text">

                </div>

                <div class="col-xs-4">

                  <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_phone_ext');?>" name="work_phone_extension" type="text">
          ...
          <div class="col-md-7">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_address_2');?>" name="address_2" type="text">
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_mobile');?>" name="mobile_phone" type="text">
            ...
            <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-xs-5">
                  ...
                  <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_city');?>" name="city" type="text">

                </div>

                <div class="col-xs-4">

                  <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_state');?>" name="state" type="text">

                </div>

                <div class="col-xs-3">

                  <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_zipcode');?>" name="zipcode" type="text">
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_home');?>" name="home_phone" type="text">
          ...
          <div class="col-md-7">
            ...
            <div class="form-group">
              ...
              <select name="country" id="select2-demo-6" class="form-control new-style" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_country');?>">
  ...
  <div class="current-tab animated fadeInRight" id="document" style="display:none;">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style date" placeholder="<?php echo $this->lang->line('xin_e_details_doe');?>" name="date_of_expiry" type="text" disabled>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_dtitle');?>" name="title" type="text">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_notifyemail');?>" name="email" type="email">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_description');?>" data-show-counter="1" data-limit="300" name="description" cols="30" rows="3" id="d_description"></textarea>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <select name="send_mail" id="send_mail" class="form-control new-style" data-plugin="select_hrm">
  ...
  <div class="current-tab animated fadeInRight" id="qualification" style="display:none;">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_inst_name');?>" name="name" type="text">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <select class="form-control new-style" name="education_level" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_e_details_edu_level');?>">
            ...
            <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <input class="form-control new-style date" placeholder="<?php echo $this->lang->line('xin_e_details_from');?>" name="from_year" type="text">

                </div>

                <div class="col-md-6">

                  <input class="form-control new-style date" placeholder="<?php echo $this->lang->line('dashboard_to');?>" name="to_year" type="text">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <select class="form-control new-style" name="language" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_e_details_language');?>">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <select class="form-control new-style" name="skill" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_e_details_skill');?>">
  ...
  <div class="current-tab animated fadeInRight" id="work_experience" style="display:none; padding-left: 0px;">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_company_name');?>" name="company_name" type="text" value="" id="company_name">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_post');?>" name="post" type="text" value="" id="post">
            ...
            <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <input class="form-control new-style date" placeholder="<?php echo $this->lang->line('xin_e_details_from');?>" name="from_date" type="text">

                </div>

                <div class="col-md-6">

                  <input class="form-control new-style date" placeholder="<?php echo $this->lang->line('dashboard_to');?>" name="to_date" type="text">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_description');?>" data-show-counter="1" data-limit="300" name="description" cols="30" rows="4" id="description"></textarea>
  ...
  <div class="current-tab animated fadeInRight" id="bank_account" style="display:none;">
      ...
      <form id="bank_account_info" action="<?php echo site_url("employees/bank_account_info") ?>" name="bank_account_info" method="post">
        ...
        <div class="col-sm-6" style="padding-left: 0px;">
          ...
          <div class="form-group">
            ...
            <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_acc_title');?>" name="account_title" type="text" value="" id="account_name">
          ...
          <div class="form-group">
            ...
            <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_acc_number');?>" name="account_number" type="text" value="" id="account_number">
        ...
        <div class="col-sm-6">
          ...
          <div class="form-group">
            ...
            <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_bank_name');?>" name="bank_name" type="text" value="" id="bank_name">
          ...
          <div class="form-group">
            ...
            <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_bank_code');?>" name="bank_code" type="text" value="" id="bank_code">
        ...
        <div class="col-sm-12" style="padding-left: 0px;">
          ...
          <div class="form-group">
            ...
            <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_bank_branch');?>" name="bank_branch" type="text" value="" id="bank_branch">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <button type="submit" class="btn btnSubmit newBtnStyle save col-right"><?php echo $this->lang->line('xin_save');?></button>
  ...
  <div class="current-tab animated fadeInRight" id="contract" style="display:none;">
      ...
      <form id="contract_info" action="<?php echo site_url("employees/contract_info") ?>" name="contract_info" method="post">
        ...
        <div class="col-md-6" style="padding-left: 0px;">
          ...
          <div class="form-group">
            ...
            <select class="form-control new-style" name="contract_type_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_one');?>">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control new-style cont_date" name="from_date" placeholder="<?php echo $this->lang->line('xin_e_details_frm_date');?>" disabled value="">
          ...
          <div class="form-group">
            ...
            <select class="form-control new-style" name="designation_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_one');?>">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_contract_title');?>" name="title" type="text" value="" id="title">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control new-style cont_date" name="to_date" placeholder="<?php echo $this->lang->line('xin_e_details_to_date');?>" disabled value="">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_description');?>" data-show-counter="1" data-limit="300" name="description" cols="30" rows="3" id="description"></textarea>
  ...
  <div class="current-tab animated fadeInRight" id="leave" style="display:none;">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              ...
              <select class="form-control new-style" name="contract_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_one');?>">
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_casual_leave');?>" name="casual_leave" type="text">
          ...
          <div class="col-md-7">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_medical_leave');?>" name="medical_leave" type="text">
  ...
  <div class="current-tab animated fadeInRight" id="shift" style="display:none;">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style date" placeholder="<?php echo $this->lang->line('xin_e_details_frm_date');?>" name="from_date" type="text" disabled>
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style date" placeholder="<?php echo $this->lang->line('xin_e_details_to_date');?>" name="to_date" type="text" disabled>
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <select class="form-control new-style" name="shift_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_one');?>">
  ...
  <div class="current-tab animated fadeInRight" id="location" style="display:none;">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style date" readonly placeholder="<?php echo $this->lang->line('xin_e_details_frm_date');?>" name="from_date" type="text">
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style date" readonly placeholder="<?php echo $this->lang->line('xin_e_details_to_date');?>" name="to_date" type="text">
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <select class="form-control new-style" name="location_id" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_select_one');?>">
  ...
  <div class="current-tab animated fadeInRight" id="change_password" style="display:none;">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_enpassword');?>" name="new_password" type="text">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input class="form-control new-style" placeholder="<?php echo $this->lang->line('xin_e_details_ecnpassword');?>" name="new_password_confirm" type="text">
