			...
			<div class="col-lg-12">
				...
				<div id="salary-slip">
					<div class="salaryslip-header">
						<div class="row">
							<div class="col-md-12">
								<center><img src="http://www.ctc.org.pk/wp-content/uploads/2015/07/logo.png" height="50px" alt="CHIP Logo"></center>
							</div>
							<div class="col-md-12">
					...
					<div class="salary-slip-footer">
						<div class="col-md-12 col-print-12 no-padding">
							<div class="col-md-5 col-print-5 no-padding">
							...
							<div class="col-md-4 col-print-4 no-padding">
								<table class="table table-bordered">
									<thead>
							...
							<div class="col-md-3 col-print-3 no-padding">
								<table class="table table-bordered">
									<thead>
