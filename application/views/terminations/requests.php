									...
									<table class="table">
								        ...
								        <tbody>
											...
											<tr style="cursor: pointer;">
												...
												<td><?= $t->notice_date; ?></td>
												<td>
													<a href="javascript:void(0);" class="label label-primary view-detail" data-id="<?= $t->id; ?>">
														 View Detail
													</a>
													<a href="javascript:void(0);" class="label label-danger terminate" data-id="<?= $t->id; ?>" style="margin-left: 5px;">
													 Terminate
													</a>
												</td>
											</tr>
