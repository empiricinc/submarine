				...
				<div class="col-lg-10">
					<div class="tabelHeading" style="margin-bottom: 0px;">
						<h3>
							...
							<button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#confirm-delete-modal">
			...
			<div class="solidLine"></div>
				<div class="row">
					...
					<div class="col-lg-12 ptb-5">
						...
						<div class="col-lg-4"><label class="label label-primary"></label></div> -->
						<div class="col-lg-2"><strong>Status</strong></div>
						<div class="col-lg-4"><label class="label label-warning"><?= $detail->status; ?></label></div>
					</div>
				...
				<div class="col-lg-12 pl-0 pr-0">
					<div class="col-lg-12">
						<h3><i class="fa fa-binoculars"></i> Investigation Updates</h3>
					</div>
					<div class="col-lg-12">
