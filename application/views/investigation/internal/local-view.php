							...
							<div class="col-md-12">
								<div class="tableMain">
									<div class="table-responsive">
										<table class="table table-hover" id="local-table-internal">
											<thead>
												<tr>
													<th>Complaint No</th>
													<th>Employee</th>
											...
											<tbody>
												...
												<?php $count=1; foreach($complaints AS $c): 
													$label = '';
													if($c->inv_status == "pending") 
														$label = "label label-warning";
													elseif($c->inv_status == "resolved")
														$label = "label label-primary";
													elseif($c->inv_status == "review")
														$label = "label label-success";
													elseif($c->inv_status == "process")
												...
												?>
													...
													<tr data-id="<?= $c->id; ?>">
														...
														<td>
															<label class="<?= $label; ?>"><?= $c->inv_status; ?></label>
														</td>
													</tr>
