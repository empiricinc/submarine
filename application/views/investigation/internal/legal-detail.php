	...
	<section class="secFormLayout">
		<div class="mainInputBg">
			...
			<div class="row">
				<!-- Form -->
				<div class="col-lg-12">
					<form action="<?= base_url(); ?>Investigation/legal_resolve" method="POST" enctype="multipart/form-data" id="legal-form-internal">
						<div class="inputFormMain col-lg-12">
							<input type="hidden" name="investigation_id" value="<?= $detail->investigation_id; ?>">
