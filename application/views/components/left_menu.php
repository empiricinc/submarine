...
<div class="site-sidebar" style="display: none;">
 ...
 <!-- dashboard_employees -->
      ...
      <li class="with-sub"> 
        <a href="javascript:void(0);" class="waves-effect  waves-light"> 
          ...
          <span class="s-text"><?php echo $this->lang->line('left_organization');?></span> 
        </a>
      ...
      <li class="with-sub"> 
          <a href="javascript:void(0);" class="waves-effect  waves-light"> 
            <span class="s-caret"><i class="fa fa-angle-down"></i></span> 
            <span class="s-icon"><i class="ti-user"></i></span> 
            <span class="s-text"><?php echo $this->lang->line('dashboard_employees');?></span> 
          </a>
      ...
      <!-- <li class="with-sub"> 
        <a href="javascript:void(0);" class="waves-effect  waves-light"> 
          <span class="s-caret"><i class="fa fa-angle-down"></i></span> 
          <span class="s-icon"><i class="fa fa-dribbble"></i></span> 
          <span class="s-text"><?php echo $this->lang->line('left_performance');?></span> 
        </a>
     ...
     <!--  <li class="with-sub"> 
        <a href="javascript:void(0);" class="waves-effect  waves-light"> 
          ...
          <span class="s-text"><?php echo $this->lang->line('left_timesheet');?></span> 
        </a>
      ...
      <?php if(in_array('36',$role_resources_ids) || in_array('38',$role_resources_ids) || in_array('39',$role_resources_ids) || in_array('40',$role_resources_ids) || in_array('41',$role_resources_ids) || in_array('42',$role_resources_ids)){?>
        ...
        <!-- payroll -->
      <!-- <li class="with-sub"> <a href="javascript:void(0);" class="waves-effect  waves-light"> 
        <span class="s-caret"><i class="fa fa-angle-down"></i></span> 
        <span class="s-icon"><i class="fa fa-calculator"></i></span> 
        <span class="s-text"><?php echo $this->lang->line('left_payroll');?></span> 
      </a>
 ...
 -->
      ...
      <li class="with-sub"> 
        <a href="javascript:void(0);" class="waves-effect  waves-light"> 
          ...
          <span class="s-text"><?php echo $this->lang->line('left_recruitment');?></span> 
        </a>
        ...
        <ul>
          ...
          <li><a href="<?php echo site_url();?>job_candidates">All Candidates</a></li>
          <li><a href="<?php echo site_url();?>job_longlisted">Long Listed</a></li>
          <li><a href="<?php echo site_url();?>job_candidates">Short Listed</a></li>
          <li><a href="<?php echo site_url();?>job_candidates">Selected Candidates </a></li>
      ...
      <!-- <li class="with-sub"> 
        <a href="javascript:void(0);" class="waves-effect  waves-light"> 
          <span class="s-caret"><i class="fa fa-angle-down"></i></span> 
          <span class="s-icon"><i class="fa fa-mortar-board"></i></span> 
          <span class="s-text"><?php echo $this->lang->line('left_training');?></span> 
        </a>
      ...
      <!-- <li class="menu-title"><?php echo $this->lang->line('xin_acc_accounting');?></li>
        ...
        <li class="with-sub"> 
          <a href="javascript:void(0);" class="waves-effect  waves-light"> 
            ...
            <span class="s-text"><?php echo $this->lang->line('xin_acc_accounts');?></span> 
          </a>
...
<!-- Transactions -->
         ...
         <!-- <li class="with-sub"> 
          <a href="javascript:void(0);" class="waves-effect  waves-light"> 
            ...
            <span class="s-text"><?php echo $this->lang->line('xin_acc_transactions');?></span> 
          </a>
...
<!-- Payers -->
        <!--  <li class="with-sub"> 
          <a href="javascript:void(0);" class="waves-effect  waves-light"> 
            ...
            <span class="s-text"><?php echo $this->lang->line('xin_acc_payees_payers');?></span> 
          </a>
       ...
       <!--  <li class="with-sub"> 
          <a href="javascript:void(0);" class="waves-effect  waves-light"> 
            ...
            <span class="s-text"><?php echo $this->lang->line('xin_acc_reports');?></span> 
          </a>
