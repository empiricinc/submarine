        ...
        <form class="form-hrm" action="<?php echo site_url("payroll/add_template") ?>" method="post" name="add_template" id="xin-form" autocomplete="off">
          ...
          <div class="bg-white">
            ...
            <div class="box-block">
              ...
              <div class="row">
                <button class="btn btn-primary pull-right"><i class="fa fa-plus icon"></i>Add More</button>
              </div>
              <div class="row">
                  <div class="col-md-4">
                      ...
                      <div class="form-group">
                        ...
                        <label for="tax_deduction"><?php echo $this->lang->line('xin_title');?></label>

                        <input class="form-control deduction" placeholder="<?php echo $this->lang->line('xin_title');?>" name="tax_deduction" type="text" value="">
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-group">
                        ...
                        <label for="tax_deduction"><?php echo $this->lang->line('xin_amount');?></label>
                    ...
                    <div class="col-md-1">
                      <div class="form-group">
                        <label for="tax_deduction"><?php echo $this->lang->line('xin_action');?></label>
                        <button class="btn btn-danger form-control"><i class="fa fa-trash-o"></i></button>
                      </div>
                    </div>
              </div>
              <div class="row">
...
<div class="box box-block bg-white">
  ...
  <h2><strong><?php echo $this->lang->line('xin_list_all_addition');?></strong> <?php echo $this->lang->line('left_payroll_templates');?>
