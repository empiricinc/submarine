  ...
  <div class="col-md-12">
    <div class="box box-block bg-white">
      <h2><strong><?php echo $this->lang->line('xin_payslip');?></strong>
        <div class="add-record-btn"> <a href="<?php echo site_url();?>payroll/pdf_create/<?php echo $gd;?>/<?php echo $make_payment_id;?>/" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $this->lang->line('xin_pdf');?>"><span <i="" class="fa fa-file-pdf-o"></span></a> </div>
      </h2>
      <div class="panel">
