	...
	<section class="secFormLayout">
		<div class="mainInputBg">
			...
			<div class="row">
				...
				<!-- Form -->
					<div class="col-lg-12">
						<form action="<?= base_url(); ?>Complaint/local_resolve" method="POST" enctype="multipart/form-data" id="legal-form">
							<div class="inputFormMain col-lg-12">
								<input type="hidden" name="remarks_id" value="<?= $detail->remarks_id; ?>">
