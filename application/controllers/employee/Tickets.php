 ...
 * @package  Ayat Ullah Khan@CTC - User > Tickets
    ...
    public function ticket_list()

     {
		...
		$data[] = array(
			...
			'<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('xin_view_details').'"><a href="'.site_url().'tickets/details/'.$r->ticket_id.'"><button type="button" class="btn btn-secondary btn-sm m-b-0-0 waves-effect waves-light"><i class="fa fa-arrow-circle-right"></i></button></a></span>',
