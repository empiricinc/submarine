 ...
 * @package  Ayat Ullah Khan@CTC - Company
...
class Company extends MY_Controller {
...

	{
       ...
       // $data['all_countries'] = $this->xin_model->get_countries();
		...
		$this->load->view('company/view_company.php', $data);
