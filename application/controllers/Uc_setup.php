...
class Uc_setup extends MY_Controller {
...

     {
       ...
       // $data['geProvinces'] = $this->All_setups_model->getAllProvinces(); 
		...
		if(in_array('4',$role_resources_ids)) {
			...
			$data['subview'] = $this->load->view("setup-form/uc_setup_list", $data, TRUE);
	...
	public function add_district() {
		...
		$result = $this->Location_model->add_district($data);
				...
				$this->session->set_flashdata('messageSuccess', 'District Added Successfully');
                redirect($_SERVER['HTTP_REFERER']); 
	...
	public function add_tehsil() {
		...
		$result = $this->Location_model->add_tehsil($data);

		 

				$this->session->set_flashdata('messageSuccess', 'Tehsil Added Successfully');
                redirect($_SERVER['HTTP_REFERER']); 
	...
	public function add_areas() {
		...
		$result = $this->Location_model->add_areas($data);
				...
				$this->session->set_flashdata('messageSuccess', 'Area Added Successfully');
                redirect($_SERVER['HTTP_REFERER']); 
	...
	public function add_sub_areas() {
		...
		$result = $this->Location_model->add_sub_areas($data);
